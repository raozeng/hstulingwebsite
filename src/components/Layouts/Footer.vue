<template>
  <footer class="footer-area">
            ...
            <ul class="footer-services-list">
              <li>
                <router-link to="/services-details"
                  >Product Engineering</router-link
                >
              </li>
              <li>
              ...
              <li>
                <router-link to="/services-details"
                  >Big Data Analysis</router-link
                >
              </li>
              <li>
                <router-link to="/services-details"
                  >Desktop Applications</router-link
                >
              </li>
              <li>
                <router-link to="/services-details"
                  >Mobile Applications</router-link
                >
              </li>
            </ul>
          </div>
    ...
    <div class="circle-map">
      <img src="../../assets/images/circle-map.png" alt="image" />
    </div>
